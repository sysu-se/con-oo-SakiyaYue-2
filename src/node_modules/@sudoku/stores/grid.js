...
export const invalidCells = derived(userGrid, $userGrid => {
	...
	if (!currentGame) return _invalidCells;
	...
	for (let y = 0; y < SUDOKU_SIZE; y++) {
		for (let x = 0; x < SUDOKU_SIZE; x++) {
			...
			if (value !== 0 && !sudoku.isValueAllowed({ row: y, col: x, value })) {
				const xy = x + ',' + y;
